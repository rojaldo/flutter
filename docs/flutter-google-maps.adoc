...
[arabic]
. link:#1-conceptos-fundamentales[Conceptos Fundamentales]
. link:#2-configuración-del-proyecto-flutter[Configuración del Proyecto Flutter]
. link:++#3-api-keys---android-e-ios++[API Keys - Android e iOS]
. link:#4-primer-mapa-en-flutter[Primer Mapa en Flutter]
. link:#5-marcadores-markers[Marcadores (Markers)]
. link:#6-polilíneas-y-polígonos[Polilíneas y Polígonos]
. link:#7-ventanas-de-información-infowindows[Ventanas de Información (InfoWindows)]
. link:#8-geolocalización-del-usuario[Geolocalización del Usuario]
. link:#9-geocoding-y-reverse-geocoding[Geocoding y Reverse Geocoding]
. link:#10-places-api-y-autocompletado[Places API y Autocompletado]
. link:#11-direcciones-y-rutas[Direcciones y Rutas]
. link:#12-personalización-del-mapa[Personalización del Mapa]
. link:#13-optimización-y-rendimiento[Optimización y Rendimiento]
. link:#14-buenas-prácticas[Buenas Prácticas]
. link:#15-proyecto-práctico-completo[Proyecto Práctico Completo]
...
[arabic]
. Ve a https://console.cloud.google.com/[Google Cloud Console]
...
Crear *dos keys separadas*: - Una para Android - Una para iOS
...
[arabic]
. Ve a https://mapstyle.withgoogle.com/[Google Maps Styling Wizard]
. Personaliza colores, visibilidad, etc.
. Exporta el JSON
. Copia el JSON en tu código
...
* https://pub.dev/packages/google_maps_flutter[google_maps_flutter package]
* https://developers.google.com/maps/documentation[Google Maps Platform Documentation]
* https://codelabs.developers.google.com/codelabs/flutter-google-maps[Flutter Google Maps Codelab]

==== Librerías Útiles

* https://pub.dev/packages/google_maps_flutter[google_maps_flutter] - Widget oficial de Google Maps
* https://pub.dev/packages/geolocator[geolocator] - Geolocalización
* https://pub.dev/packages/geocoding[geocoding] - Geocoding
* https://pub.dev/packages/flutter_google_places[flutter_google_places] - Places autocompletado
* https://pub.dev/packages/google_maps_cluster_manager[google_maps_cluster_manager] - Clustering de marcadores

==== Herramientas

* https://console.cloud.google.com/[Google Cloud Console]
* https://mapstyle.withgoogle.com/[Google Maps Styling Wizard]
* https://github.com/googlemaps/android-maps-utils[API Key Checker]
...
Crear una app que: - Centre el mapa en la ubicación del usuario - Muestre un marcador azul en la posición actual - Permita actualizar la ubicación con un botón

==== Ejercicio 2: Buscador de Lugares

Crear una app que: - Tenga un campo de búsqueda con autocompletado - Muestre resultados en el mapa - Permita ver detalles del lugar seleccionado

==== Ejercicio 3: Calculadora de Rutas

Crear una app que: - Permita seleccionar origen y destino - Calcule la ruta entre ambos puntos - Muestre distancia y tiempo estimado - Dibuje la polilínea en el mapa

==== Ejercicio 4: App de Tracking

Crear una app que: - Rastree la ubicación del usuario en tiempo real - Dibuje una polilínea con el recorrido - Calcule la distancia total recorrida - Guarde el recorrido para verlo después
...
[arabic]
. *Configuración*: API Keys para Android e iOS con restricciones de seguridad
. *Mapas interactivos*: GoogleMap widget, cámara, gestos
. *Marcadores*: Iconos personalizados, InfoWindows, clustering
. *Overlays*: Polilíneas, polígonos, círculos
. *Geolocalización*: Permisos, ubicación actual, seguimiento
. *APIs*: Geocoding, Places, Directions
. *Optimización*: Gestión de marcadores, caché, lazy loading
. *Buenas prácticas*: Seguridad, testing, ciclo de vida
